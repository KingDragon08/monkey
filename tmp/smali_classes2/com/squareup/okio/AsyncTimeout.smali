...
.method static declared-synchronized awaitTimeout()Lcom/squareup/okio/AsyncTimeout;
    ...
    iget-object v1, v1, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    .line 337
    if-nez v1, :cond_0

    .line 338
    const-class v1, Lcom/squareup/okio/AsyncTimeout;
    ...
    invoke-direct {v1, v4, v5}, Lcom/squareup/okio/AsyncTimeout;->remainingNanos(J)J
    ...
    iget-object v3, v1, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    iput-object v3, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    .line 356
    const/4 v0, 0x0

    iput-object v0, v1, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;
    :try_end_2
...
.method private static declared-synchronized cancelScheduledTimeout(Lcom/squareup/okio/AsyncTimeout;)Z
    ...
    .line 128
    iget-object v2, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    if-ne v2, p0, :cond_0

    .line 129
    iget-object v2, p0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    iput-object v2, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    .line 130
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static declared-synchronized scheduleTimeout(Lcom/squareup/okio/AsyncTimeout;JZ)V
    ...
    .line 86
    new-instance v0, Lcom/squareup/okio/AsyncTimeout;

    invoke-direct {v0}, Lcom/squareup/okio/AsyncTimeout;-><init>()V

    sput-object v0, Lcom/squareup/okio/AsyncTimeout;->head:Lcom/squareup/okio/AsyncTimeout;

    .line 87
    new-instance v0, Lcom/squareup/okio/AsyncTimeout$Watchdog;

    invoke-direct {v0}, Lcom/squareup/okio/AsyncTimeout$Watchdog;-><init>()V

    invoke-virtual {v0}, Lcom/squareup/okio/AsyncTimeout$Watchdog;->start()V
    ...
    iput-wide v4, p0, Lcom/squareup/okio/AsyncTimeout;->timeoutAt:J

    .line 104
    :goto_0
    invoke-direct {p0, v2, v3}, Lcom/squareup/okio/AsyncTimeout;->remainingNanos(J)J
    ...
    .line 106
    :goto_1
    iget-object v6, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    if-eqz v6, :cond_1

    iget-object v6, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    invoke-direct {v6, v2, v3}, Lcom/squareup/okio/AsyncTimeout;->remainingNanos(J)J
    ...
    iput-object v2, p0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;

    .line 108
    iput-object p0, v0, Lcom/squareup/okio/AsyncTimeout;->next:Lcom/squareup/okio/AsyncTimeout;
    ...
    .line 110
    const-class v0, Lcom/squareup/okio/AsyncTimeout;
...
.method public final enter()V
    ...
    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/squareup/okio/AsyncTimeout;->inQueue:Z
    ...
    iput-boolean v3, p0, Lcom/squareup/okio/AsyncTimeout;->inQueue:Z

    .line 79
    invoke-static {p0, v0, v1, v2}, Lcom/squareup/okio/AsyncTimeout;->scheduleTimeout(Lcom/squareup/okio/AsyncTimeout;JZ)V
...
.method final exit(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/squareup/okio/AsyncTimeout;->newTimeoutException(Ljava/io/IOException;)Ljava/io/IOException;
