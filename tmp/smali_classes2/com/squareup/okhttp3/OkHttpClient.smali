...
.method private constructor <init>(Lcom/squareup/okhttp3/OkHttpClient$Builder;)V
    ...
    .line 207
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->dispatcher:Lcom/squareup/okhttp3/Dispatcher;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->dispatcher:Lcom/squareup/okhttp3/Dispatcher;

    .line 208
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->proxy:Ljava/net/Proxy;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->proxy:Ljava/net/Proxy;

    .line 209
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->protocols:Ljava/util/List;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->protocols:Ljava/util/List;

    .line 210
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->connectionSpecs:Ljava/util/List;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->connectionSpecs:Ljava/util/List;

    .line 211
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->interceptors:Ljava/util/List;

    invoke-static {v0}, Lcom/squareup/okhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->interceptors:Ljava/util/List;

    .line 212
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->networkInterceptors:Ljava/util/List;

    invoke-static {v0}, Lcom/squareup/okhttp3/internal/Util;->immutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->networkInterceptors:Ljava/util/List;

    .line 213
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->proxySelector:Ljava/net/ProxySelector;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->proxySelector:Ljava/net/ProxySelector;

    .line 214
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->cookieJar:Lcom/squareup/okhttp3/CookieJar;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->cookieJar:Lcom/squareup/okhttp3/CookieJar;

    .line 215
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->cache:Lcom/squareup/okhttp3/Cache;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->cache:Lcom/squareup/okhttp3/Cache;

    .line 216
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->internalCache:Lcom/squareup/okhttp3/internal/cache/InternalCache;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->internalCache:Lcom/squareup/okhttp3/internal/cache/InternalCache;

    .line 217
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->socketFactory:Ljavax/net/SocketFactory;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->socketFactory:Ljavax/net/SocketFactory;
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp3/ConnectionSpec;->isTls()Z
    ...
    .line 224
    :cond_2
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;

    .line 226
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->certificateChainCleaner:Lcom/squareup/okhttp3/internal/tls/CertificateChainCleaner;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->certificateChainCleaner:Lcom/squareup/okhttp3/internal/tls/CertificateChainCleaner;

    .line 233
    :goto_2
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;

    .line 234
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->certificatePinner:Lcom/squareup/okhttp3/CertificatePinner;

    iget-object v1, p0, Lcom/squareup/okhttp3/OkHttpClient;->certificateChainCleaner:Lcom/squareup/okhttp3/internal/tls/CertificateChainCleaner;

    invoke-virtual {v0, v1}, Lcom/squareup/okhttp3/CertificatePinner;->withCertificateChainCleaner(Lcom/squareup/okhttp3/internal/tls/CertificateChainCleaner;)Lcom/squareup/okhttp3/CertificatePinner;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->certificatePinner:Lcom/squareup/okhttp3/CertificatePinner;

    .line 236
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->proxyAuthenticator:Lcom/squareup/okhttp3/Authenticator;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->proxyAuthenticator:Lcom/squareup/okhttp3/Authenticator;

    .line 237
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->authenticator:Lcom/squareup/okhttp3/Authenticator;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->authenticator:Lcom/squareup/okhttp3/Authenticator;

    .line 238
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->connectionPool:Lcom/squareup/okhttp3/ConnectionPool;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->connectionPool:Lcom/squareup/okhttp3/ConnectionPool;

    .line 239
    iget-object v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->dns:Lcom/squareup/okhttp3/Dns;

    iput-object v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->dns:Lcom/squareup/okhttp3/Dns;

    .line 240
    iget-boolean v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->followSslRedirects:Z

    iput-boolean v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->followSslRedirects:Z

    .line 241
    iget-boolean v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->followRedirects:Z

    iput-boolean v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->followRedirects:Z

    .line 242
    iget-boolean v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->retryOnConnectionFailure:Z

    iput-boolean v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->retryOnConnectionFailure:Z

    .line 243
    iget v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->connectTimeout:I

    iput v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->connectTimeout:I

    .line 244
    iget v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->readTimeout:I

    iput v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->readTimeout:I

    .line 245
    iget v0, p1, Lcom/squareup/okhttp3/OkHttpClient$Builder;->writeTimeout:I

    iput v0, p0, Lcom/squareup/okhttp3/OkHttpClient;->writeTimeout:I
    ...
    .line 229
    invoke-direct {p0, v0}, Lcom/squareup/okhttp3/OkHttpClient;->systemDefaultSslSocketFactory(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;

    move-result-object v1

    iput-object v1, p0, Lcom/squareup/okhttp3/OkHttpClient;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;
