.class public Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;
...
.method public data(ZILcom/squareup/okio/BufferedSource;I)V
    ...
    invoke-static {v0, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1300(Lcom/squareup/okhttp3/internal/framed/FramedConnection;I)Z
    ...
    invoke-static {v0, p2, p3, p4, p1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1400(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ILcom/squareup/okio/BufferedSource;IZ)V
    ...
    invoke-virtual {v0, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->getStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    invoke-virtual {v0, p2, v1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->writeSynResetLater(ILcom/squareup/okhttp3/internal/framed/ErrorCode;)V

    .line 614
    int-to-long v0, p4

    invoke-interface {p3, v0, v1}, Lcom/squareup/okio/BufferedSource;->skip(J)V
...
.method protected execute()V
    ...
    iget-boolean v1, v1, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->client:Z

    if-nez v1, :cond_0

    .line 587
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;->frameReader:Lcom/squareup/okhttp3/internal/framed/FrameReader;

    invoke-interface {v1}, Lcom/squareup/okhttp3/internal/framed/FrameReader;->readConnectionPreface()V

    .line 589
    :cond_0
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;->frameReader:Lcom/squareup/okhttp3/internal/framed/FrameReader;

    invoke-interface {v1, p0}, Lcom/squareup/okhttp3/internal/framed/FrameReader;->nextFrame(Lcom/squareup/okhttp3/internal/framed/FrameReader$Handler;)Z
    ...
    invoke-static {v2, v0, v1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1200(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_3

    .line 601
    :goto_0
    iget-object v0, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;->frameReader:Lcom/squareup/okhttp3/internal/framed/FrameReader;
    ...
    # invokes: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    invoke-static {v2, v1, v0}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1200(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    :try_end_4
    ...
    # invokes: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    invoke-static {v3, v1, v2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1200(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    :try_end_5
...
.method public goAway(ILcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okio/ByteString;)V
    ...
    invoke-static {v0}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1900(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/util/Map;
    ...
    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1900(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/util/Map;
    ...
    new-array v2, v2, [Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    invoke-static {v2, v3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1602(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Z)Z
    ...
    .line 771
    invoke-virtual {v3}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->getId()I

    move-result v4

    if-le v4, p1, :cond_1

    invoke-virtual {v3}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->isLocallyInitiated()Z
    ...
    invoke-virtual {v3, v4}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->receiveRstStream(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    invoke-virtual {v4, v3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method public headers(ZZIILjava/util/List;Lcom/squareup/okhttp3/internal/framed/HeadersMode;)V
    ...
    # invokes: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->pushedStream(I)Z
    invoke-static {v0, p3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1300(Lcom/squareup/okhttp3/internal/framed/FramedConnection;I)Z
    ...
    invoke-static {v0, p3, p5, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1500(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ILjava/util/List;Z)V
    ...
    invoke-static {v0}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1600(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Z
    ...
    invoke-virtual {v0, p3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->getStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    invoke-virtual {v0, p3, v1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->writeSynResetLater(ILcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    invoke-static {v0}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1700(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)I
    ...
    invoke-static {v1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1800(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)I
    ...
    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->hostname:Ljava/lang/String;
    invoke-static {v7}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1100(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;

    goto/16 :goto_0

    .line 680
    :cond_7
    invoke-virtual {v0, p5, p6}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->receiveHeaders(Ljava/util/List;Lcom/squareup/okhttp3/internal/framed/HeadersMode;)V
...
.method public ping(ZII)V
    ...
    invoke-static {v0, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$2400(Lcom/squareup/okhttp3/internal/framed/FramedConnection;I)Lcom/squareup/okhttp3/internal/framed/Ping;
    ...
    invoke-static {v0, v1, p2, p3, v2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$2500(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ZIILcom/squareup/okhttp3/internal/framed/Ping;)V
...
.method public rstStream(ILcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    # invokes: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->pushedStream(I)Z
    invoke-static {v0, p1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1300(Lcom/squareup/okhttp3/internal/framed/FramedConnection;I)Z
    ...
    invoke-static {v0, p1, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$2200(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ILcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method public settings(ZLcom/squareup/okhttp3/internal/framed/Settings;)V
    ...
    iget-object v2, v2, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->peerSettings:Lcom/squareup/okhttp3/internal/framed/Settings;

    const/high16 v3, 0x10000

    invoke-virtual {v2, v3}, Lcom/squareup/okhttp3/internal/framed/Settings;->getInitialWindowSize(I)I
    ...
    iget-object v3, v3, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->peerSettings:Lcom/squareup/okhttp3/internal/framed/Settings;

    invoke-virtual {v3}, Lcom/squareup/okhttp3/internal/framed/Settings;->clear()V
    ...
    invoke-virtual {v3, p2}, Lcom/squareup/okhttp3/internal/framed/Settings;->merge(Lcom/squareup/okhttp3/internal/framed/Settings;)V
    ...
    .line 703
    invoke-direct {p0, p2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;->applyAndAckSettings(Lcom/squareup/okhttp3/internal/framed/Settings;)V
    ...
    invoke-virtual {v3, v4}, Lcom/squareup/okhttp3/internal/framed/Settings;->getInitialWindowSize(I)I
    ...
    invoke-static {v4}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$2300(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Z
    ...
    invoke-virtual {v4, v2, v3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->addBytesToWriteWindow(J)V
    ...
    invoke-static {v4, v5}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$2302(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Z)Z
    ...
    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    invoke-static {v4}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1900(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/util/Map;
    ...
    new-instance v3, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader$2;
    ...
    iget-object v12, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;->this$0:Lcom/squareup/okhttp3/internal/framed/FramedConnection;

    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedConnection;->hostname:Ljava/lang/String;
    invoke-static {v12}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->access$1100(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/lang/String;

    move-result-object v12

    aput-object v12, v10, v11

    invoke-direct {v3, p0, v9, v10}, Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader$2;-><init>(Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 725
    :try_start_1
    invoke-virtual {v1, v4, v5}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->addBytesToWriteWindow(J)V
...
.method public windowUpdate(IJ)V
    ...
    iget-wide v2, v0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->bytesLeftInWriteWindow:J

    add-long/2addr v2, p2

    iput-wide v2, v0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->bytesLeftInWriteWindow:J
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->getStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    .line 788
    :try_start_1
    invoke-virtual {v1, p2, p3}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->addBytesToWriteWindow(J)V
