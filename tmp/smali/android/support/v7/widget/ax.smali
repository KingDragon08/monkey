...
.method private b()V
    ...
    .line 159
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ax;->b:Landroid/support/v7/widget/ak;
...
.method private d()Landroid/widget/Spinner;
    ...
    sget v3, Lcom/ss/android/ugc/live/R$attr;->actionDropDownStyle:I
...
.method a(Landroid/support/v7/app/a$c;Z)Landroid/support/v7/widget/ax$c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/ax;->h:I

    invoke-direct {v1, v2, v3}, Landroid/widget/AbsListView$LayoutParams;-><init>(II)V

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax$c;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax$c;->setFocusable(Z)V

    .line 301
    iget-object v1, p0, Landroid/support/v7/widget/ax;->e:Landroid/support/v7/widget/ax$b;

    if-nez v1, :cond_1

    .line 302
    new-instance v1, Landroid/support/v7/widget/ax$b;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/ax$b;-><init>(Landroid/support/v7/widget/ax;)V

    iput-object v1, p0, Landroid/support/v7/widget/ax;->e:Landroid/support/v7/widget/ax$b;

    .line 304
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ax;->e:Landroid/support/v7/widget/ax$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ax$c;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public a(I)V
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v7/widget/ax;->a:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ax;->removeCallbacks(Ljava/lang/Runnable;)Z

    .line 264
    :cond_0
    new-instance v1, Landroid/support/v7/widget/ax$1;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/ax$1;-><init>(Landroid/support/v7/widget/ax;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v7/widget/ax;->a:Ljava/lang/Runnable;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ax;->setContentHeight(I)V
    ...
    iput v0, p0, Landroid/support/v7/widget/ax;->d:I
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 372
    invoke-virtual {p2}, Landroid/support/v7/widget/ax$c;->getTab()Landroid/support/v7/app/a$c;
...
.method public onMeasure(II)V
    ...
    .line 99
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ax;->setFillViewport(Z)V

    .line 101
    iget-object v4, p0, Landroid/support/v7/widget/ax;->b:Landroid/support/v7/widget/ak;
    ...
    iput v3, p0, Landroid/support/v7/widget/ax;->c:I

    .line 109
    :goto_1
    iget v3, p0, Landroid/support/v7/widget/ax;->c:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/ax;->g:Z
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/ax;->b:Landroid/support/v7/widget/ak;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/ak;->measure(II)V

    .line 121
    iget-object v1, p0, Landroid/support/v7/widget/ax;->b:Landroid/support/v7/widget/ak;

    invoke-virtual {v1}, Landroid/support/v7/widget/ak;->getMeasuredWidth()I
    ...
    .line 136
    iget v0, p0, Landroid/support/v7/widget/ax;->i:I
...
.method public setTabSelected(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ak;->getChildAt(I)Landroid/view/View;
