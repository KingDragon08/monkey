...
.field private k:Landroid/support/v4/util/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_textfield_search_default_mtrl_alpha:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_textfield_default_mtrl_alpha:I

    aput v1, v0, v4

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_ab_share_pack_mtrl_alpha:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_commit_search_api_mtrl_alpha:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_seekbar_tick_mark_material:I

    aput v1, v0, v4

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_menu_share_mtrl_alpha:I

    aput v1, v0, v5

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_menu_copy_mtrl_am_alpha:I

    aput v1, v0, v6

    const/4 v1, 0x4

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_menu_cut_mtrl_alpha:I

    aput v2, v0, v1

    const/4 v1, 0x5

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_menu_selectall_mtrl_alpha:I

    aput v2, v0, v1

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_ic_menu_paste_mtrl_am_alpha:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_textfield_activated_mtrl_alpha:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_textfield_search_activated_mtrl_alpha:I

    aput v1, v0, v4

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_cab_background_top_mtrl_alpha:I

    aput v1, v0, v5

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_text_cursor_material:I

    aput v1, v0, v6

    const/4 v1, 0x4

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_left_mtrl_dark:I

    aput v2, v0, v1

    const/4 v1, 0x5

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_middle_mtrl_dark:I

    aput v2, v0, v1

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_right_mtrl_dark:I

    aput v1, v0, v7

    const/4 v1, 0x7

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_left_mtrl_light:I

    aput v2, v0, v1

    const/16 v1, 0x8

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_middle_mtrl_light:I

    aput v2, v0, v1

    const/16 v1, 0x9

    sget v2, Lcom/ss/android/ugc/live/R$drawable;->abc_text_select_handle_right_mtrl_light:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_popup_background_mtrl_mult:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_cab_background_internal_bg:I

    aput v1, v0, v4

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_menu_hardkey_panel_mtrl_mult:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_tab_indicator_material:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_textfield_search_material:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_btn_check_material:I

    aput v1, v0, v3

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_btn_radio_material:I
...
.method static a(I)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 518
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_switch_thumb_material:I
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 278
    :cond_2
    sget v0, Lcom/ss/android/ugc/live/R$drawable;->abc_seekbar_track_material:I
    ...
    sget v2, Lcom/ss/android/ugc/live/R$attr;->colorControlNormal:I
    ...
    sget v1, Lcom/ss/android/ugc/live/R$attr;->colorControlActivated:I
    ...
    .line 286
    :cond_3
    sget v0, Lcom/ss/android/ugc/live/R$drawable;->abc_ratingbar_material:I

    if-eq p2, v0, :cond_4

    sget v0, Lcom/ss/android/ugc/live/R$drawable;->abc_ratingbar_indicator_material:I

    if-eq p2, v0, :cond_4

    sget v0, Lcom/ss/android/ugc/live/R$drawable;->abc_ratingbar_small_material:I
    ...
    sget v2, Lcom/ss/android/ugc/live/R$attr;->colorControlActivated:I
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    check-cast v0, Landroid/support/v4/util/f;
    ...
    .line 401
    :cond_0
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/util/f;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/util/f;->b(J)V
...
.method private static a(Landroid/support/v7/widget/k;)V
    ...
    new-instance v1, Landroid/support/v7/widget/k$d;

    invoke-direct {v1}, Landroid/support/v7/widget/k$d;-><init>()V
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/k$c;)V
    ...
    .prologue
    .line 494
    iget-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/util/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/util/a;

    .line 497
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/util/a;

    invoke-virtual {v0, p1, p2}, Landroid/support/v4/util/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 462
    :cond_4
    sget v4, Lcom/ss/android/ugc/live/R$drawable;->abc_list_divider_mtrl_alpha:I
    ...
    .line 466
    :cond_5
    sget v4, Lcom/ss/android/ugc/live/R$drawable;->abc_dialog_material_background:I
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, v3}, Landroid/support/v4/util/f;->b(JLjava/lang/Object;)V
...
.method private b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 585
    sget v0, Lcom/ss/android/ugc/live/R$attr;->colorButtonNormal:I
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 246
    :cond_2
    sget v4, Lcom/ss/android/ugc/live/R$drawable;->abc_cab_background_top_material:I
    ...
    sget v6, Lcom/ss/android/ugc/live/R$drawable;->abc_cab_background_internal_bg:I
    ...
    sget v5, Lcom/ss/android/ugc/live/R$drawable;->abc_cab_background_top_mtrl_alpha:I
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 595
    sget v0, Lcom/ss/android/ugc/live/R$attr;->colorAccent:I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v4/util/a;->isEmpty()Z
    ...
    .line 310
    iget-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/util/k;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/util/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/util/k;
    ...
    .line 385
    iget-object v1, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/util/k;
    ...
    .line 362
    iget-object v7, p0, Landroid/support/v7/widget/k;->l:Landroid/support/v4/util/k;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/util/k;->c(ILjava/lang/Object;)V

    .line 365
    iget-object v7, p0, Landroid/support/v7/widget/k;->k:Landroid/support/v4/util/a;

    invoke-virtual {v7, v0}, Landroid/support/v4/util/a;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private e(Landroid/content/Context;)V
    ...
    .line 711
    sget v0, Lcom/ss/android/ugc/live/R$drawable;->abc_vector_test:I
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 605
    sget v3, Lcom/ss/android/ugc/live/R$attr;->colorControlHighlight:I
    ...
    .line 606
    sget v4, Lcom/ss/android/ugc/live/R$attr;->colorButtonNormal:I
...
.method b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 531
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_edit_text_material:I

    if-ne p2, v1, :cond_2

    .line 532
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_edittext:I
    ...
    .line 533
    :cond_2
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_switch_track_mtrl_alpha:I

    if-ne p2, v1, :cond_3

    .line 534
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_switch_track:I
    ...
    .line 536
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_switch_thumb:I
    ...
    .line 537
    :cond_4
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_btn_default_mtrl_shape:I
    ...
    .line 539
    :cond_5
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_btn_borderless_material:I
    ...
    .line 541
    :cond_6
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_btn_colored_material:I
    ...
    .line 543
    :cond_7
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_spinner_mtrl_am_alpha:I

    if-eq p2, v1, :cond_8

    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_spinner_textfield_background_material:I

    if-ne p2, v1, :cond_9

    .line 545
    :cond_8
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_spinner:I
    ...
    .line 547
    sget v0, Lcom/ss/android/ugc/live/R$attr;->colorControlNormal:I
    ...
    .line 549
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_default:I
    ...
    .line 551
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_btn_checkable:I
    ...
    .line 552
    :cond_c
    sget v1, Lcom/ss/android/ugc/live/R$drawable;->abc_seekbar_thumb_material:I

    if-ne p2, v1, :cond_0

    .line 553
    sget v0, Lcom/ss/android/ugc/live/R$color;->abc_tint_seek_thumb:I
