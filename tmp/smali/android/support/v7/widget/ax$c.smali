.class public Landroid/support/v7/widget/ax$c;
...
.method public constructor <init>(Landroid/support/v7/widget/ax;Landroid/content/Context;Landroid/support/v7/app/a$c;Z)V
    ...
    .line 391
    sget v0, Lcom/ss/android/ugc/live/R$attr;->actionBarTabStyle:I

    invoke-direct {p0, p2, v3, v0}, Landroid/support/v7/widget/ak;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v1, Lcom/ss/android/ugc/live/R$attr;->actionBarTabStyle:I
...
.method public a()V
    ...
    .line 451
    iget-object v2, p0, Landroid/support/v7/widget/ax$c;->c:Landroid/support/v7/app/a$c;
    ...
    .line 457
    :cond_0
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ax$c;->addView(Landroid/view/View;)V
    ...
    .line 468
    iput-object v7, p0, Landroid/support/v7/widget/ax$c;->f:Landroid/view/View;
    ...
    .line 475
    iget-object v4, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    .line 477
    new-instance v5, Landroid/support/v7/widget/ak$a;

    invoke-direct {v5, v8, v8}, Landroid/support/v7/widget/ak$a;-><init>(II)V

    .line 479
    iput v9, v5, Landroid/support/v7/widget/ak$a;->h:I

    .line 480
    invoke-virtual {v4, v5}, Landroid/widget/ImageView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 481
    invoke-virtual {p0, v4, v1}, Landroid/support/v7/widget/ax$c;->addView(Landroid/view/View;I)V

    .line 482
    iput-object v4, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    sget v6, Lcom/ss/android/ugc/live/R$attr;->actionBarTabTextStyle:I
    ...
    .line 502
    iput-object v4, p0, Landroid/support/v7/widget/ax$c;->d:Landroid/widget/TextView;
    ...
    .line 505
    iget-object v3, p0, Landroid/support/v7/widget/ax$c;->d:Landroid/widget/TextView;
    ...
    :cond_9
    :goto_3
    iget-object v3, p0, Landroid/support/v7/widget/ax$c;->e:Landroid/widget/ImageView;
    ...
    .line 516
    invoke-virtual {p0, p0}, Landroid/support/v7/widget/ax$c;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V
    ...
    .line 518
    :cond_e
    invoke-virtual {p0, v7}, Landroid/support/v7/widget/ax$c;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    .line 519
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ax$c;->setLongClickable(Z)V
...
.method public getTab()Landroid/support/v7/app/a$c;
    .locals 1
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .prologue
    .line 424
    invoke-super {p0, p1}, Landroid/support/v7/widget/ak;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    .prologue
    .line 431
    invoke-super {p0, p1}, Landroid/support/v7/widget/ak;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 527
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ax$c;->getLocationOnScreen([I)V
    ...
    .line 530
    invoke-virtual {p0}, Landroid/support/v7/widget/ax$c;->getWidth()I

    move-result v2

    .line 531
    invoke-virtual {p0}, Landroid/support/v7/widget/ax$c;->getHeight()I
    ...
    .line 534
    iget-object v5, p0, Landroid/support/v7/widget/ax$c;->c:Landroid/support/v7/app/a$c;
...
.method public onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Landroid/support/v7/widget/ak;->onMeasure(II)V
...
.method public setSelected(Z)V
    ...
    .line 416
    :goto_0
    invoke-super {p0, p1}, Landroid/support/v7/widget/ak;->setSelected(Z)V
