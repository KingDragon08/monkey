...
.method a()V
    ...
    .line 255
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/h;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/z$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/h;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/h;
    ...
    iget-object v2, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/h;
...
.method a(Landroid/support/v4/content/h;Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/aa;->g:Landroid/support/v4/app/s;
    ...
    iget-object v0, v0, Landroid/support/v4/app/aa;->g:Landroid/support/v4/app/s;
    ...
    iget-object v1, v1, Landroid/support/v4/app/s;->d:Landroid/support/v4/app/FragmentManagerImpl;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/z$a;->a(Landroid/support/v4/content/h;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/aa;->g:Landroid/support/v4/app/s;
    ...
    iget-object v2, v2, Landroid/support/v4/app/s;->d:Landroid/support/v4/app/FragmentManagerImpl;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aa$a;->a(Landroid/support/v4/content/h;Ljava/lang/Object;)V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/h;
    ...
    iget-object v3, p0, Landroid/support/v4/app/aa$a;->d:Landroid/support/v4/content/h;

    invoke-interface {v0, v3}, Landroid/support/v4/app/z$a;->a(Landroid/support/v4/content/h;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
