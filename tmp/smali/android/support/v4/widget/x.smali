...
.field private final r:Landroid/support/v4/widget/x$a;
...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/x$a;)V
    ...
    .line 385
    iput-object p3, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/widget/u;->a(Landroid/content/Context;Landroid/view/animation/Interpolator;)Landroid/support/v4/widget/u;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/widget/x;->q:Landroid/support/v4/widget/u;
...
.method private a(III)I
    ...
    .line 636
    invoke-direct {p0, v0}, Landroid/support/v4/widget/x;->a(F)F
...
.method private a(Landroid/view/View;IIII)I
    ...
    .line 621
    :goto_1
    iget-object v4, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/x$a;->b(Landroid/view/View;)I
...
.method private a(FF)V
    ...
    .line 770
    iget-object v0, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    iget-object v1, p0, Landroid/support/v4/widget/x;->s:Landroid/view/View;

    invoke-virtual {v0, v1, p1, p2}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;FF)V
...
.method private a(FFI)V
    ...
    .prologue
    .line 838
    invoke-direct {p0, p3}, Landroid/support/v4/widget/x;->f(I)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v4/widget/x;->e(II)I
...
.method private a(FFII)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    invoke-virtual {v2, p4}, Landroid/support/v4/widget/x$a;->b(I)Z
    ...
    .line 1279
    iget-object v1, p0, Landroid/support/v4/widget/x;->j:[I
...
.method private a(IIII)Z
    ...
    .line 594
    iget-object v1, p0, Landroid/support/v4/widget/x;->q:Landroid/support/v4/widget/u;
    ...
    .line 600
    iget-object v4, p0, Landroid/support/v4/widget/x;->q:Landroid/support/v4/widget/u;
...
.method private a(Landroid/view/View;FF)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;)I
    ...
    .line 1300
    :goto_1
    iget-object v3, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;
    ...
    iget v4, p0, Landroid/support/v4/widget/x;->b:I
...
.method private b(FFI)V
    ...
    .line 1264
    iget-object v1, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    invoke-virtual {v1, v0, p3}, Landroid/support/v4/widget/x$a;->b(II)V
...
.method private b(IIII)V
    ...
    invoke-static {v3, v4}, Landroid/support/v4/view/ae;->e(Landroid/view/View;I)V
    ...
    invoke-virtual {v3, v4, p2, p4}, Landroid/support/v4/widget/x$a;->b(Landroid/view/View;II)I
    ...
    invoke-static {v4, v5}, Landroid/support/v4/view/ae;->d(Landroid/view/View;I)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;IIII)V
...
.method private c(Landroid/view/MotionEvent;)V
    ...
    .line 850
    invoke-direct {p0, v2}, Landroid/support/v4/widget/x;->g(I)Z
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    .line 963
    :cond_0
    iget-object v2, p0, Landroid/support/v4/widget/x;->l:Landroid/view/VelocityTracker;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/x;->l:Landroid/view/VelocityTracker;
    ...
    .line 973
    invoke-direct {p0, v0, v1, v2}, Landroid/support/v4/widget/x;->a(FFI)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    .line 979
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/widget/x;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/widget/x$a;->a(II)V
    ...
    .line 994
    invoke-direct {p0, v2, v1, v0}, Landroid/support/v4/widget/x;->a(FFI)V
    ...
    .line 999
    iget v2, p0, Landroid/support/v4/widget/x;->p:I
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v4/widget/x$a;->a(II)V
    ...
    invoke-virtual {p0, v2, v1}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    .line 1006
    invoke-virtual {p0, v1, v0}, Landroid/support/v4/widget/x;->b(Landroid/view/View;I)Z
    ...
    .line 1021
    invoke-direct {p0, v3}, Landroid/support/v4/widget/x;->g(I)Z
    ...
    invoke-virtual {p0, v0, v4}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    invoke-direct {p0, v4, v5, v6}, Landroid/support/v4/widget/x;->a(Landroid/view/View;FF)Z
    ...
    .line 1038
    iget-object v9, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    float-to-int v10, v5

    invoke-virtual {v9, v4, v8, v10}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;II)I
    ...
    .line 1042
    iget-object v11, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    float-to-int v12, v6

    invoke-virtual {v11, v4, v10, v12}, Landroid/support/v4/widget/x$a;->b(Landroid/view/View;II)I
    ...
    invoke-virtual {v11, v4}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;)I

    move-result v11

    .line 1046
    iget-object v12, p0, Landroid/support/v4/widget/x;->r:Landroid/support/v4/widget/x$a;

    invoke-virtual {v12, v4}, Landroid/support/v4/widget/x$a;->b(Landroid/view/View;)I
    ...
    .line 1053
    :cond_a
    invoke-direct {p0, v5, v6, v3}, Landroid/support/v4/widget/x;->b(FFI)V
    ...
    invoke-virtual {p0, v4, v3}, Landroid/support/v4/widget/x;->b(Landroid/view/View;I)Z
...
.method public a(Z)Z
    ...
    .line 726
    iget-object v0, p0, Landroid/support/v4/widget/x;->q:Landroid/support/v4/widget/u;
    ...
    invoke-static {v0, v4}, Landroid/support/v4/view/ae;->e(Landroid/view/View;I)V
    ...
    invoke-static {v0, v5}, Landroid/support/v4/view/ae;->d(Landroid/view/View;I)V
    ...
    .line 754
    :cond_5
    invoke-virtual {p0, v6}, Landroid/support/v4/widget/x;->c(I)V
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v3, v4}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    .line 1116
    invoke-virtual {p0, v3, v0}, Landroid/support/v4/widget/x;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/x;->c(II)Z
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/widget/x;->g(I)Z
    ...
    invoke-direct {p0, v2, v3, v1, v0}, Landroid/support/v4/widget/x;->b(IIII)V
    ...
    .line 1188
    invoke-direct {p0, v3, v5, v6}, Landroid/support/v4/widget/x;->a(Landroid/view/View;FF)Z
    ...
    .line 1189
    invoke-virtual {p0, v3, v2}, Landroid/support/v4/widget/x;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v5, v6}, Landroid/support/v4/widget/x;->d(II)Landroid/view/View;
    ...
    .line 1222
    invoke-direct {p0}, Landroid/support/v4/widget/x;->h()V
    ...
    .line 1239
    invoke-direct {p0, v5, v5}, Landroid/support/v4/widget/x;->a(FF)V
...
.method public b(II)Z
    ...
    .line 1359
    :goto_2
    iget-object v4, p0, Landroid/support/v4/widget/x;->f:[F
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v4/widget/x$a;->a(Landroid/view/View;I)Z
...
.method public d(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/x$a;->c(I)I
...
.method public d(I)Z
    ...
    .line 1329
    invoke-virtual {p0, p1, v1}, Landroid/support/v4/widget/x;->b(II)Z
