...
.field private c:Lcom/ss/android/download/m;

.field private d:Lcom/ss/android/download/DownloadService$a;

.field private e:Lcom/ss/android/download/c;
...
.field private h:Lcom/ss/android/download/f;
...
.method public constructor <init>()V
    ...
    .line 246
    new-instance v0, Lcom/ss/android/download/DownloadService$1;

    invoke-direct {v0, p0}, Lcom/ss/android/download/DownloadService$1;-><init>(Lcom/ss/android/download/DownloadService;)V
...
.method private a(Lcom/ss/android/download/DownloadInfo$a;J)Lcom/ss/android/download/DownloadInfo;
    ...
    .prologue
    .line 436
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/n;

    iget-object v1, p0, Lcom/ss/android/download/DownloadService;->c:Lcom/ss/android/download/m;

    iget-object v2, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;

    invoke-virtual {p1, p0, v0, v1, v2}, Lcom/ss/android/download/DownloadInfo$a;->a(Landroid/content/Context;Lcom/ss/android/download/n;Lcom/ss/android/download/m;Lcom/ss/android/download/c;)Lcom/ss/android/download/DownloadInfo;
...
.method private a(J)V
    ...
    .line 472
    :cond_2
    iget-object v1, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;

    invoke-static {v0}, Lcom/ss/android/download/c;->b(Lcom/ss/android/download/DownloadInfo;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/ss/android/download/c;->a(Ljava/lang/String;)V
...
.method static synthetic d(Lcom/ss/android/download/DownloadService;)Lcom/ss/android/download/c;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;
...
.method private d()Z
    ...
    iget-object v2, v0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/n;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/ss/android/download/e;->a(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {v14, v2, v7}, Lcom/ss/android/download/DownloadInfo$a;-><init>(Lcom/ss/android/download/e;Landroid/database/Cursor;)V
    ...
    invoke-virtual {v2, v8, v9, v10}, Lcom/ss/android/download/e;->a(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I

    .line 362
    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;

    invoke-virtual {v8, v3}, Lcom/ss/android/download/c;->a(Lcom/ss/android/download/DownloadInfo;)V
    ...
    invoke-static {v3}, Lcom/ss/android/download/c;->b(Lcom/ss/android/download/DownloadInfo;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v8, v9}, Lcom/ss/android/download/c;->a(Ljava/lang/String;)V
    ...
    .line 365
    :cond_2
    invoke-virtual {v3}, Lcom/ss/android/download/DownloadInfo;->d()V
    ...
    iget-object v9, v0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/f;

    invoke-virtual {v3, v9}, Lcom/ss/android/download/DownloadInfo;->a(Lcom/ss/android/download/f;)Z
    :try_end_1
    ...
    iget-object v2, v0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;
    ...
    invoke-virtual {v2, v6}, Lcom/ss/android/download/c;->a(Ljava/util/Collection;)V
    ...
    .line 416
    invoke-static {}, Lcom/ss/android/download/h;->d()Z
    ...
    .line 420
    invoke-static {v7, v2, v4, v5, v6}, Lcom/bytedance/common/b/e;->a(Landroid/app/AlarmManager;IJLandroid/app/PendingIntent;)V
    :try_end_6
...
.method static synthetic g(Lcom/ss/android/download/DownloadService;)Lcom/ss/android/download/f;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/f;
...
.method public onCreate()V
    ...
    invoke-static {v0}, Lcom/ss/android/download/h;->a(Landroid/content/Context;)Z
    ...
    .line 159
    invoke-static {p0}, Lcom/ss/android/download/l;->a(Landroid/content/Context;)Lcom/ss/android/download/l;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/n;
    ...
    invoke-direct {v0, p0}, Lcom/ss/android/download/m;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->c:Lcom/ss/android/download/m;
    ...
    invoke-direct {v0, p0}, Lcom/ss/android/download/f;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/f;

    .line 171
    invoke-static {p0}, Lcom/ss/android/download/c;->a(Landroid/content/Context;)Lcom/ss/android/download/c;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;

    .line 172
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/c;

    invoke-virtual {v0}, Lcom/ss/android/download/c;->a()V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/download/f;->a()V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-static {v1}, Lcom/ss/android/download/h;->a(Landroid/content/Context;)Z
