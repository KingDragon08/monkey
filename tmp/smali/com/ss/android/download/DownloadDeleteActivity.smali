...
.method private a(Landroid/database/Cursor;)V
    ...
    .line 93
    :cond_4
    sget v1, Lcom/ss/android/ugc/live/R$string;->notification_download_delete:I
    ...
    invoke-virtual {v1, v4}, Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;->setTitle(I)Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;

    move-result-object v4

    invoke-virtual {v4, v0}, Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;

    move-result-object v0

    sget v4, Lcom/ss/android/ugc/live/R$string;->label_ok:I

    new-instance v5, Lcom/ss/android/download/DownloadDeleteActivity$3;

    invoke-direct {v5, p0, v2, v3}, Lcom/ss/android/download/DownloadDeleteActivity$3;-><init>(Lcom/ss/android/download/DownloadDeleteActivity;J)V

    .line 96
    invoke-virtual {v0, v4, v5}, Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;

    move-result-object v0

    sget v2, Lcom/ss/android/ugc/live/R$string;->label_cancel:I

    new-instance v3, Lcom/ss/android/download/DownloadDeleteActivity$2;

    invoke-direct {v3, p0}, Lcom/ss/android/download/DownloadDeleteActivity$2;-><init>(Lcom/ss/android/download/DownloadDeleteActivity;)V
    ...
    new-instance v2, Lcom/ss/android/download/DownloadDeleteActivity$1;

    invoke-direct {v2, p0}, Lcom/ss/android/download/DownloadDeleteActivity$1;-><init>(Lcom/ss/android/download/DownloadDeleteActivity;)V

    .line 107
    invoke-virtual {v0, v2}, Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)Lcom/bytedance/ies/uikit/dialog/AlertDialog$Builder;
