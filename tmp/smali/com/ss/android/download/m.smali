.class public Lcom/ss/android/download/m;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 51
    iput v0, p0, Lcom/ss/android/download/m;->d:I

    .line 69
    iput v0, p0, Lcom/ss/android/download/m;->f:I

    .line 80
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/ss/android/download/m;->g:Ljava/lang/Thread;

    .line 57
    iput-object p1, p0, Lcom/ss/android/download/m;->e:Landroid/content/Context;

    .line 58
    invoke-static {p1}, Lcom/ss/android/download/m;->a(Landroid/content/Context;)Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/m;->c:Ljava/io/File;
    ...
    iput-object v0, p0, Lcom/ss/android/download/m;->a:Ljava/io/File;
    ...
    iput-object v0, p0, Lcom/ss/android/download/m;->b:Ljava/io/File;

    .line 61
    invoke-direct {p0}, Lcom/ss/android/download/m;->c()V
...
.method private declared-synchronized a(J)I
    ...
    :try_start_0
    iget v0, p0, Lcom/ss/android/download/m;->d:I
...
.method private a(IJ)J
    ...
    .line 274
    iget-object v0, p0, Lcom/ss/android/download/m;->e:Landroid/content/Context;
    ...
    .line 300
    iget-object v6, p0, Lcom/ss/android/download/m;->e:Landroid/content/Context;

    invoke-static {v6}, Lcom/ss/android/download/e;->a(Landroid/content/Context;)Lcom/ss/android/download/e;
    ...
    .line 300
    invoke-virtual {v6, v4, v5, v7}, Lcom/ss/android/download/e;->a(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static synthetic a(Lcom/ss/android/download/m;)V
    .locals 0

    .prologue
    .line 27
    invoke-direct {p0}, Lcom/ss/android/download/m;->d()V
...
.method private declared-synchronized a(Ljava/io/File;JI)V
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1}, Lcom/ss/android/download/m;->b(Ljava/io/File;)J
    ...
    invoke-direct {p0, p4, v0, v1}, Lcom/ss/android/download/m;->a(IJ)J
    ...
    .line 171
    iget-object v2, p0, Lcom/ss/android/download/m;->b:Ljava/io/File;
    ...
    .line 181
    :cond_4
    iget-object v2, p0, Lcom/ss/android/download/m;->c:Ljava/io/File;
    ...
    .line 183
    iget-object v0, p0, Lcom/ss/android/download/m;->c:Ljava/io/File;

    invoke-direct {p0, v0}, Lcom/ss/android/download/m;->a(Ljava/io/File;)J
...
.method static synthetic b(Lcom/ss/android/download/m;)V
    .locals 0

    .prologue
    .line 27
    invoke-direct {p0}, Lcom/ss/android/download/m;->e()V
...
.method private declared-synchronized c()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/ss/android/download/m;->g:Ljava/lang/Thread;
    ...
    :cond_0
    :try_start_1
    new-instance v0, Lcom/ss/android/download/m$1;

    invoke-direct {v0, p0}, Lcom/ss/android/download/m$1;-><init>(Lcom/ss/android/download/m;)V
...
.method private d()V
    ...
    .line 334
    iget-object v0, p0, Lcom/ss/android/download/m;->b:Ljava/io/File;
...
.method private e()V
    ...
    .line 402
    iget-object v4, p0, Lcom/ss/android/download/m;->e:Landroid/content/Context;

    invoke-static {v4}, Lcom/ss/android/download/e;->a(Landroid/content/Context;)Lcom/ss/android/download/e;
    ...
    invoke-virtual {v4, v3, v5, v6}, Lcom/ss/android/download/e;->a(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
...
.method a(Ljava/lang/String;IJ)Ljava/io/File;
    ...
    iget-object v2, p0, Lcom/ss/android/download/m;->a:Ljava/io/File;
...
.method declared-synchronized a()V
    ...
    :try_start_0
    iget v0, p0, Lcom/ss/android/download/m;->f:I
...
.method a(ILjava/lang/String;J)V
    ...
    .prologue
    .line 97
    invoke-direct {p0, p3, p4}, Lcom/ss/android/download/m;->a(J)I
    ...
    .line 101
    :cond_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/ss/android/download/m;->b(ILjava/lang/String;J)V
...
.method b(ILjava/lang/String;J)V
    ...
    .prologue
    .line 105
    invoke-direct {p0}, Lcom/ss/android/download/m;->f()V
    ...
    .line 116
    :pswitch_0
    iget-object v0, p0, Lcom/ss/android/download/m;->a:Ljava/io/File;

    goto :goto_0

    .line 119
    :pswitch_1
    iget-object v1, p0, Lcom/ss/android/download/m;->a:Ljava/io/File;
    ...
    .line 121
    :cond_3
    iget-object v1, p0, Lcom/ss/android/download/m;->c:Ljava/io/File;
    ...
    .line 123
    :cond_4
    iget-object v1, p0, Lcom/ss/android/download/m;->b:Ljava/io/File;
    ...
    .line 132
    :cond_5
    invoke-direct {p0, v0, p3, p4, p1}, Lcom/ss/android/download/m;->a(Ljava/io/File;JI)V
